...
function Footer() {
  return (
    <footer className="container mx-auto py-6 lg:rounded-xl mt-6 bg-zinc-100 dark:bg-neutral-800 lg:mb-4 lg:rounded-xl max-lg:rounded-t-lg max-md:rounded-t-0">
      <div className="mb-2">
        <SymOutline className="size-12 dark:text-white" />
      </div>

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="col-span-2 lg:col-span-1">
          <div className="font-bold dark:text-white">COMPA</div>
          ...
          <div className="flex gap-4">
            <a
              className="inline-flex items-center rounded-lg gap-2 px-2 py-1 bg-zinc-200 dark:bg-neutral-700 dark:bg-opacity-50 font-medium dark:text-white"
              href="https://github.com/blackmann/compa"
            >
              <div className="i-lucide-github dark:text-white"></div>
              Source code
            </a>
        ...
        <div className="lg:col-start-3 col-span-1">
          <header className="font-bold dark:text-white">Project</header>
