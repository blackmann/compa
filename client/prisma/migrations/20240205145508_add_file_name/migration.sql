...
INSERT INTO "new_Media" ("contentType", "createdAt", "duration", "id", "postId", "size", "thumbnail", "updatedAt", "url", "userId") SELECT "contentType", "createdAt", "duration", "id", "postId", "size", "thumbnail", "updatedAt", "url", "userId" FROM "Media";
DROP TABLE "Media";
