...
INSERT INTO "new_Post" ("commentsCount", "content", "createdAt", "deleted", "downvotes", "id", "parentId", "path", "people", "quoteId", "tags", "updatedAt", "upvotes", "userId") SELECT "commentsCount", "content", "createdAt", "deleted", "downvotes", "id", "parentId", "path", "people", "quoteId", "tags", "updatedAt", "upvotes", "userId" FROM "Post";
DROP TABLE "Post";
