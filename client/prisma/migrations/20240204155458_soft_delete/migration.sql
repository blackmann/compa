...
INSERT INTO "new_Post" ("commentsCount", "content", "createdAt", "downvotes", "id", "parentId", "people", "quoteId", "updatedAt", "upvotes", "userId") SELECT "commentsCount", "content", "createdAt", "downvotes", "id", "parentId", "people", "quoteId", "updatedAt", "upvotes", "userId" FROM "Post";
DROP TABLE "Post";
